...
function tellMe(joke) {
    VoiceRSS.speech({
        key: '79a3d2c7f97a4e8aa5bfab7f7bac5823',
        src: joke,
        hl: 'en-us',
        v: 'Linda',
        r: 0, 
...
async function getJokes() {
    let joke = '';
    const apiUrl = 'https://v2.jokeapi.dev/joke/Pun?blacklistFlags=religious,political,racist,sexist,explicit';
    try {
        ...
        // Catch errors Here
        console.log('Nope, this does not work', error);
    }
}
